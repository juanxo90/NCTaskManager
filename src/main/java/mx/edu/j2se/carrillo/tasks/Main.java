...
public class Main {
	public static void main(String[] args) {
		...
		Task task2 = new Task("Morning running", 5, 25, 5);
		...
		System.out.println("The task will be : " + task1.nextTimeAfter());
		...
		System.out.println("The task will be : " + task2.nextTimeAfter());
